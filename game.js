const sleep = (ms = 0) => new Promise(resolve => setTimeout(resolve, ms)); var Module = typeof Module != "undefined" ? Module : {};
...
(() => {
  ...
  loadPackage({
    "files": [ {
      "filename": "/assets/Roboto-Regular.ttf",
      "start": 0,
      "end": 168260
    }, {
      "filename": "/assets/background-music.wav",
      "start": 168260,
      "end": 30723940,
      "audio": 1
    }, {
...
var ASM_CONSTS = {
  ...
  307502713: () => window.innerWidth,
  307502743: () => window.innerHeight
};
